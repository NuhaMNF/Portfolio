...
export const projects = [
  {
    ...
    category: "AI Systems",
    description:
      "A production multi-agent retrieval system that orchestrates query planning, hybrid search, and reranking with evaluator feedback loops.",
  ...
  },
  {
    ...
    description:
      "A latent diffusion model trained on field recordings. Generates 10s of coherent soundscapes conditioned on text and visual cues.",
  ...
  },
  {
    ...
    category: "MLOps",
    description:
      "An analytics layer that streams inference logs + drift metrics into a queryable timeseries store. Web-based lab notebook for SREs.",
  ...
  },
  {
    ...
    description:
      "Vision transformer pre-trained for layout-aware document understanding. Beats prior SOTA by 6.2 mAP on three public benchmarks.",
  ...
  },
  {
    ...
    description:
      "A graph-based runtime for building type-safe data pipelines in TypeScript. Live reload, schema-aware migrations, IDE-grade errors.",
...
export const commands = [
  { id: "hero", label: "go to hero", shortcut: "g h" },
